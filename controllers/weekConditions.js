        ...
        .then((spots) => {
            ...
            const urlPromises = spots.map((spot) => {
                ...
                return Promise.all([
                    ...
                    const weekConditions = marineData.time.map((time, index) => {
                        const waveHeight = marineData.wave_height_max[index]
                        const waveDirection = marineData.wave_direction_dominant[index]
                        const wavePeriod = marineData.wave_period_max[index]
                        const windSpeed10m = forecastData.wind_speed_10m_max[index]
                        const windDirection10m = forecastData.wind_direction_10m_dominant[index]
                    
                    if (
                        waveHeight !== null && waveHeight !== undefined &&
                        waveDirection !== null && waveDirection !== undefined &&
                        wavePeriod !== null && wavePeriod !== undefined &&
                        windSpeed10m !== null && windSpeed10m !== undefined &&
                        windDirection10m !== null && windDirection10m !== undefined
                    ) {
                        return {
                            time,
